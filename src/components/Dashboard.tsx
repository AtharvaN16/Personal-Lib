    ...
    <div className="page-container" style={styles.frame}>
      ...
      <main style={styles.mainLayout}>
        ...
        <motion.div 
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 1.8, duration: 1.0, ease: [0.25, 1, 0.5, 1] }} // load at 1.8s alongside header
        >
          {/* Sticky 2nd line */}
          <motion.div
            style={{
          ...
          <motion.div 
            ...
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 2.5, duration: 0.8 }} // Grid content delayed to 2.5s
          >
            <AnimatePresence>
              {books
                .filter(b => {
...
const styles: Record<string, React.CSSProperties> = {
  ...
  booksSection: {
    ...
    marginTop: '-260px', // Pulled up further to account for the sticky filter line height and align perfectly at start
    paddingTop: '40px',
    paddingBottom: '80px',
  },
  filterStickyBar: {
