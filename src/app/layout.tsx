...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${instrumentSans.variable} ${caveat.variable} ${newsreader.variable}`} suppressHydrationWarning>
      <head>
